import { idempotentWriteAnnotations, openWorldMutationAnnotations, readOnlyAnnotations, writeAnnotations } from "../annotations.js";
import {
  agentRunsHandler,
  codexReviewHandler,
...
export const delegationTools = [
  ...
  defineTool({ name: "repo_continue_agent_run", title: "Continue a managed agent run", package: "delegation", tier: "specialist", annotations: openWorldMutationAnnotations, taskMutationBoundary: "self_managed_external", handler: continueAgentRunHandler }),
